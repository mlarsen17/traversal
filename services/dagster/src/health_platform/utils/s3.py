...
def resolve_s3_settings() -> S3Settings:
    endpoint_url = _pick(os.getenv("S3_ENDPOINT_URL"), os.getenv("MINIO_ENDPOINT_URL"))
    ...
    is_minio = bool(endpoint_url and ("minio" in endpoint_url or "127.0.0.1" in endpoint_url or "localhost" in endpoint_url))
